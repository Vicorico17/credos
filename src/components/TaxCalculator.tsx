...
export default function TaxCalculator({ entityType }: Props) {
  ...
  return (
    <div className="w-full max-w-4xl bg-white/80 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden">
      <div className="p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-green-50 p-6 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="ml-4 px-6 py-3 text-sm font-bold text-blue-600 hover:text-blue-700 focus:outline-none hover:bg-blue-50 rounded-lg transition-colors"
                >
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition-all duration-200 hover:scale-[1.02] text-base font-bold shadow-lg"
            >
              Calculate
            </button>
          </div>
